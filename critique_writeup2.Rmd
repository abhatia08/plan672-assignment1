...
<center>
```{r, echo=FALSE, fig.align= 'center', fig.cap= 'Figure 3. Basemap Example', out.width= '800'}
...
<center>
```{r, echo=FALSE, fig.align= 'center', fig.cap= 'Figure 7. Satellite image of Prison Context', out.width= '800'}
knitr::include_graphics(here("figures","satellite_image_example.png"))
...
# library(shiny)
# 
# shiny::includeHTML(here("figures","interactive.html"))
```
